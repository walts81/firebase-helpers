...
function updateItemInFirebaseArray(parentRef, item, arr, mapArr, commit, mutation, firebaseConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const { mapArrToUse, commitToUse, mutationToUse, configToUse } = (0, args_helper_1.getArgsToUse)(mapArr, commit, mutation, firebaseConfig);
